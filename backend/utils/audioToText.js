...
/**
 * Sends the filename to FastAPI for transcription
 * @param {string} filename - Just the name, e.g., "hello.webm"
 * @returns {Promise<string>} - Transcribed text
 */
const convertAudioToText = async (filename) => {
  const filePath = path.join('..', 'backend', 'uploads', 'voices', filename);
