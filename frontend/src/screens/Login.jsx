          ...
          <div className="mt-6">
            ...
            {/* <div className="mt-6 flex justify-center space-x-3">
              <div>
                <a
                  href="#"
                  className="w-full inline-flex justify-center py-2 px-4 border border-muted rounded-md shadow-sm bg-background text-sm font-medium text-muted-foreground hover:bg-muted"
                >
